...
- **Overflow and scrolling.** `overflow: 'hidden' | 'scroll' | 'auto'` on any container, rounded clipping, `position: 'sticky'`, overlay scrollbars that fade, and `scrollIntoView` wired to keyboard focus.
