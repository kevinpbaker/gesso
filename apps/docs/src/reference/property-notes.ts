...
export const PROPERTY_NOTES: Readonly<Record<string, PropertyNote>> = {
  ...
  // Spacing
  padding: { group: 'Spacing', note: 'Space inside the border on all four sides. A number, never a tuple.' },
  paddingX: { group: 'Spacing', note: 'Space inside the border, left and right. The idiom, over a pair of sides.' },
  paddingY: { group: 'Spacing', note: 'Space inside the border, top and bottom. The idiom, over a pair of sides.' },
  paddingTop: { group: 'Spacing', note: 'Overrides `paddingY` on the top edge. For one edge, not for an axis.' },
  ...
  marginTop: { group: 'Spacing', note: 'Overrides `marginY` on the top edge. For one edge, not for an axis.' },
